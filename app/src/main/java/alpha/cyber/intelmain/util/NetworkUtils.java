...
//    }
    ...
    public static boolean isHaveNet(Context context){
        ...
        if(networkType_self== NetworkUtils.SelfNetState.NET_WIFI||networkType_self==NetworkUtils.SelfNetState.NET_2G
                ||networkType_self==NetworkUtils.SelfNetState.NET_3G||networkType_self==NetworkUtils.SelfNetState.NET_4G
                //有线网络
                ||networkType_self==NetworkUtils.SelfNetState.NET_UNKNOWN){
            return true;
        }else{
            return false;
        }
