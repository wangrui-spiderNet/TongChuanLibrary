...
public class SocketConstants {
    ...
    public static final String e_mail_address = "BE";
    ...
    public static final String unrenewed_items = "BN";
    ...
    public static final String fee_type = "BT";
    ...
    public static final String fee_identifier = "CG";
