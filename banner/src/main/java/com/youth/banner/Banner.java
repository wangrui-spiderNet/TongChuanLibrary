...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private void setImageList(List<?> imagesUrl) {
        ...
        for (int i = 0; i <= count + 1; i++) {
            ...
            if (imageView == null) {
                imageView = new RelativeLayout(context);
            }
...
//        Log.i(tag, ev.getAction() + "--" + isAutoPlay);
    ...
    class BannerPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            RelativeLayout view = (RelativeLayout) views.get(position);
            ...
            view.setOnFocusChangeListener(new OnFocusChangeListener() {
                ...
                public void onFocusChange(View v, boolean hasFocus) {
                    if(hasFocus){
                        ((RelativeLayout) views.get(position)).getChildAt(0).setBackgroundResource(R.drawable.home_corner_orange_strocke_bg);
                        stopAutoPlay();
                    }else{
                         ((RelativeLayout) views.get(position)).getChildAt(0).setBackgroundResource(R.color.transparent);
                        startAutoPlay();
                    }
                }
            });
